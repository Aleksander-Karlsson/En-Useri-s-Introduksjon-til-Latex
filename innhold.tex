...
\end{figure}
        ...
        [H] setter hvor streng \LaTeX\hspace{1pt} skal være når det plasserer bildet. ``H'' er here (og \textbf{krever} \textbackslash usepackage\{float\}) Hvis du vil ha en mindre streng plassering/ikke lyst til å lese seksjonen om usepackages kan du prøve ``h'' eller ``h!''.
...
% % Eks tabell som ser helt forferdelig ut men som viser de mest brukte funksjonene i tabeller:
% \begin{table}[h!]
%     \centering
