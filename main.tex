...
\usepackage{lmodern}
\usepackage[norwegian]{babel} % Gir tabeller og figurer norske navn, f.eks står det "Referanser" i stede for "References" Følg med, dette funker ikke heeelt som det skal.
...
\input{tikz-settings} % Tikz-definisjonene ble litt vel lange så puttet det i en egen fil
...
\begin{document}
    ...
    \input{innhold} % Setter inn fila "innhold.tex" her
